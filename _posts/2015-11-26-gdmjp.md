...
<a name="#intro"></a>
## Introduction
先日[Google Developers Meetup #1](http://googledevjp.blogspot.jp/2015/11/google-developers-meetup-1-11-26.html)に参加してきました。
...
- デモのAsteroidで人同時接続とかするとどうなりますか？  
そもそも最適化していない。ブラウザの描画が間に合わないかも。このゲームはフレームごとに同期しているので厳しいかも。RPGなら問題ない。
